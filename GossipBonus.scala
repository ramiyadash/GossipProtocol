	...
	algo.toLowerCase() match {
		...
		// prepare a message and send this to the random node.  
  		case "gossip" => 
  		  ...
  		  var msg:String = "g" + "Ramiya is new CEO of facebook."
  		  //val rnd = new scala.util.Random
  		  //NOTE: Ramiya val range = nodecount*10 to nodecount*1000
  		  //NOTE: Ramiya var random:Int = rnd.nextInt(range.length)  	
  		  //NOTE: Ramiya Just check if this random generator has an issue with index. 
  		  var random = Int.MaxValue
